...
root = Tk()
root.wm_title("Projection Stereo")
...
label_euler.configure(text='''Angle Euler (phi1,phi, phi2)''')
...
diff_label.configure(text='''Vecteur g''')
...
label_euler1.configure(text='''Rotations selon x y et z''')
...
label_addpole.configure(text='''Ajouter un pole''')
...
addpole_button.configure(text='''Ajouter''')
...
sym_button.configure(text='''Symetrie''')
...
trace_plan_button.configure(text='''Trace plan''')
...
trace_plan_sym_button.configure(text='''Trace plan Sym''')
...
trace_schmid.configure(text='''Trace Schmid''')
...
label_coord.configure(text='''Tilt, inclinaison''')
...
color_trace_vert=Radiobutton(master=root, text="vert", variable=col_trace, value=1).place(relx=0.67,rely=0.93,height=21,width=71)
color_trace_bleu=Radiobutton(master=root, text="bleu", variable=col_trace, value=2).place(relx=0.72,rely=0.93,height=21,width=71)
color_trace_rouge=Radiobutton(master=root, text="rouge", variable=col_trace, value=3).place(relx=0.77,rely=0.93,height=21,width=71)

size_var_label= Label (master=root)
size_var_label.place(relx=0.67,rely=0.96,height=19,width=100)
size_var_label.configure(text='''Taille marqueurs''')
...
largeur_button.configure(text='''Largeur''')
...
schmid_button.configure(text='''Facteur de Schmid''')
...
diff_label2.configure(text='''Inclinaison''')
...
rot_diff_label.configure(text='''Rotation autour du vecteur g''')
...
trace_plan_button.configure(command=trace_addplan)
trace_plan_button.configure(pady="0")
trace_plan_button.configure(text='''Draw Plane''')

trace_plan_sym_button = Button (master=root)
trace_plan_sym_button.place(relx=0.81,rely=0.43,height=31,width=97)
trace_plan_sym_button.configure(command=trace_plan_sym)
trace_plan_sym_button.configure(pady="0")
trace_plan_sym_button.configure(text='''Draw Sym Planes''')
...
trace_schmid.configure(command=schmid_trace)
trace_schmid.configure(pady="0")
trace_schmid.configure(text='''Draw Schmid''')
...
col_trace.set(2)
mainloop()     
>>>>>>> 52436e95a545e62e4935808dd895b2c1fc5daa43
