...
class Ui_StereoProj(object):
    def setupUi(self, StereoProj):
        ...
        self.gridLayout_4.addWidget(self.d_label_2, 11, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.d_label_var_2, 11, 6, 1, 1)
        self.d_entry_2 = QtGui.QLineEdit(self.crystal2_box)
        self.d_entry_2.setObjectName(_fromUtf8("d_entry_2"))
        self.gridLayout_4.addWidget(self.d_entry_2, 11, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.reciprocal_checkBox_2, 6, 0, 1, 5)
        self.e_entry_2 = QtGui.QLineEdit(self.crystal2_box)
        self.e_entry_2.setObjectName(_fromUtf8("e_entry_2"))
        self.gridLayout_4.addWidget(self.e_entry_2, 5, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.alphabetagamma_entry_2, 3, 2, 1, 4)
        self.gridLayout_13.addWidget(self.crystal2_box, 0, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.d_label_var, 12, 6, 1, 1)
        self.d_entry = QtGui.QLineEdit(self.groupBox)
        self.d_entry.setObjectName(_fromUtf8("d_entry"))
        self.gridLayout_2.addWidget(self.d_entry, 12, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.reciprocal_checkBox, 7, 0, 1, 5)
        self.e_entry = QtGui.QLineEdit(self.groupBox)
        self.e_entry.setObjectName(_fromUtf8("e_entry"))
        self.gridLayout_2.addWidget(self.e_entry, 6, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.alphabetagamma_label, 4, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.e_label, 6, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.dm_button, 12, 2, 1, 1)
        self.dp_button = QtGui.QPushButton(self.groupBox)
        self.dp_button.setObjectName(_fromUtf8("dp_button"))
        self.gridLayout_2.addWidget(self.dp_button, 12, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.abc_entry, 1, 2, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.alphabetagamma_entry, 4, 2, 1, 4)
        ...
        self.gridLayout_12.addWidget(self.tilt_angle_entry, 1, 1, 1, 1)
        self.image_tilt_y_label = QtGui.QLabel(self.groupBox_7)
        self.image_tilt_y_label.setObjectName(_fromUtf8("image_tilt_y_label"))
        self.gridLayout_12.addWidget(self.image_tilt_y_label, 2, 0, 1, 1)
        ...
        self.image_tilt_y_label_entry = QtGui.QLineEdit(self.groupBox_7)
        self.image_tilt_y_label_entry.setObjectName(_fromUtf8("image_tilt_y_label_entry"))
        self.gridLayout_12.addWidget(self.image_tilt_y_label_entry, 2, 1, 1, 1)
        self.tilt_angle_label = QtGui.QLabel(self.groupBox_7)
        self.tilt_angle_label.setObjectName(_fromUtf8("tilt_angle_label"))
        self.gridLayout_12.addWidget(self.tilt_angle_label, 1, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.uvw_button, 6, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.hexa_button, 7, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.diff_entry, 0, 1, 1, 2)
        self.tilt_entry = QtGui.QLineEdit(self.groupBox_2)
        self.tilt_entry.setObjectName(_fromUtf8("tilt_entry"))
        self.gridLayout_3.addWidget(self.tilt_entry, 1, 1, 1, 2)
        self.gridLayout_9.addWidget(self.groupBox_2, 1, 1, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.wulff_button, 2, 2, 1, 3)
        self.gridLayout_9.addWidget(self.groupBox_9, 2, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.lock_checkButton, 0, 0, 1, 3)
        ...
        self.gridLayout_8.addWidget(self.angle_alpha_label, 1, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.angle_alpha_buttonm, 1, 1, 1, 1)
        self.angle_alpha_entry = QtGui.QLineEdit(self.groupBox_3)
        self.angle_alpha_entry.setObjectName(_fromUtf8("angle_alpha_entry"))
        self.gridLayout_8.addWidget(self.angle_alpha_entry, 1, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.angle_alpha_buttonp, 1, 3, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.alpha_signBox, 1, 4, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.angle_alpha_label_2, 1, 5, 1, 1)
        self.angle_beta_label = QtGui.QLabel(self.groupBox_3)
        self.angle_beta_label.setObjectName(_fromUtf8("angle_beta_label"))
        self.gridLayout_8.addWidget(self.angle_beta_label, 2, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.angle_beta_buttonm, 2, 1, 1, 1)
        self.angle_beta_entry = QtGui.QLineEdit(self.groupBox_3)
        self.angle_beta_entry.setObjectName(_fromUtf8("angle_beta_entry"))
        self.gridLayout_8.addWidget(self.angle_beta_entry, 2, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.angle_beta_buttonp, 2, 3, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.beta_signBox, 2, 4, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.theta_signBox, 3, 4, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.angle_z_label_2, 3, 5, 1, 1)
        ...
        StereoProj.setTabOrder(self.color_trace_vert, self.style_box)
