...
# Form implementation generated from reading ui file 'stereo-pyqt3.ui'
#
...
class Ui_StereoProj(object):
    def setupUi(self, StereoProj):
        ...
        self.gridLayout_2.addWidget(self.dm_button, 7, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.d_entry, 7, 2, 1, 1)
        self.dp_button = QtGui.QPushButton(self.groupBox)
        self.dp_button.setObjectName(_fromUtf8("dp_button"))
        self.gridLayout_2.addWidget(self.dp_button, 7, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.d_label_var, 7, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.beta_label, 1, 4, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.lock_checkButton, 0, 0, 1, 3)
    ...
    def retranslateUi(self, StereoProj):
        ...
        self.alpha_label.setText(_translate("StereoProj", "alpha", None))
        self.beta_label.setText(_translate("StereoProj", "beta", None))
        self.gamma_label.setText(_translate("StereoProj", "gamma", None))
