...
class Ui_StereoProj(object):
    def setupUi(self, StereoProj):
        ...
        self.gridLayout_3.addWidget(self.diff_entry, 3, 0, 1, 4)
        ...
        self.gridLayout_2.addWidget(self.space_group_Box, 7, 0, 1, 5)
        ...
        self.gridLayout_2.addWidget(self.d_label_var, 9, 4, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.reset_view_button, 7, 0, 1, 3)
        ...
        self.gridLayout_10.addWidget(self.text_size_label, 6, 0, 1, 1)
        self.text_size_entry = QtGui.QLineEdit(self.groupBox_9)
        self.text_size_entry.setObjectName(_fromUtf8("text_size_entry"))
        self.gridLayout_10.addWidget(self.text_size_entry, 6, 2, 1, 1)
        ...
        self.tilt_angle_label = QtGui.QLabel(self.groupBox_3)
        self.tilt_angle_label.setObjectName(_fromUtf8("tilt_angle_label"))
        self.gridLayout_4.addWidget(self.tilt_angle_label, 13, 0, 1, 4)
        self.tilt_angle_entry = QtGui.QLineEdit(self.groupBox_3)
        self.tilt_angle_entry.setObjectName(_fromUtf8("tilt_angle_entry"))
        self.gridLayout_4.addWidget(self.tilt_angle_entry, 14, 0, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.mplwindow, 0, 0, 1, 1)
    ...
    def retranslateUi(self, StereoProj):
        ...
        self.angle_z_label.setText(_translate("StereoProj", "<p> &theta;/z </p>", None))
        self.angle_beta_label.setText(_translate("StereoProj", "<p>&beta;/x</p>", None))
        self.angle_alpha_label.setText(_translate("StereoProj", "<p>&alpha;/y </p>", None))
        self.lock_checkButton.setText(_translate("StereoProj", "Lock Axes", None))
        self.tilt_angle_label.setText(_translate("StereoProj", "Tilt axis angle", None))
