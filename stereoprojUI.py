...
class Ui_StereoProj(object):
    def setupUi(self, StereoProj):
        ...
        self.gridLayout_3.addWidget(self.button_trace, 12, 0, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.tilt_label, 4, 0, 1, 3)
        self.tilt_entry = QtGui.QLineEdit(self.groupBox_2)
        self.tilt_entry.setObjectName(_fromUtf8("tilt_entry"))
        self.gridLayout_3.addWidget(self.tilt_entry, 10, 0, 1, 4)
        ...
        StereoProj.setTabOrder(self.diff_entry, self.inclinaison_entry)
    ...
    def retranslateUi(self, StereoProj):
        ...
        self.tilt_angle_label.setText(_translate("StereoProj", "α-tilt/y- axis angle", None))
